import { getCorsOptions, corsMiddleware, preflightHandler } from './corsConfig';
...
describe('getCorsOptions', () => {
  ...
  describe('origin handling', () => {
    ...
    it('should reject non-whitelisted origins in production', (done) => {
      ...
      originFn('http://malicious.com', (err: any, allowed: boolean) => {
...
describe('corsMiddleware', () => {
  ...
  it('should be callable with request, response, and next', () => {
    const middleware = corsMiddleware();
